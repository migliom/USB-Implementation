...
COMPONENT_FILES	:= rising_edge_detector.sv falling_edge_detect.sv ahb_slave.sv fifo_data_buffer.sv flex_counter_tx.sv flex_pts_sr_tx.sv usb_rx.sv rx_decoder.sv rx_edge_detector.sv rx_eop_detector.sv rx_flex_counter.sv rx_flex_stp_sr.sv rx_rcu.sv rx_sync_high.sv rx_sync_low.sv rx_timer.sv usb_tx.sv tx_control_fsm.sv tx_timer.sv tx_encoder.sv tx_shift_register.sv tx_pid_byte.sv tx_sync_byte.sv tx_mux.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= usb_endpoint.sv
